			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/category/create')}}"><i class="icon-tasks"></i><span class="hidden-tablet">Add Caregory</span></a></li>

						<li><a href="{{URL::to('/manufacture')}}"><i class="icon-eye-open"></i><span class="hidden-tablet">All Brand</span></a></li>
						<li><a href="{{URL::to('/manufacture/create')}}">Add Brand<i class="icon-dashboard"></i></a></li>
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{URL::to('/product')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">All Product</span></a></li>
								<li><a class="submenu" href="{{URL::to('/product/create')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">Add Product</span></a></li>
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{URL::to('/slider')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">All Slider</span></a></li>
								<li><a class="submenu" href="{{URL::to('/slider/create')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">Add slider</span></a></li>
								
							</ul>	
						</li>

						<li><a href="chart.html"><i class="icon-list-alt"></i><span class="hidden-tablet">Social icon</span></a></li>
						<li><a href="typography.html"><i class="icon-font"></i><span class="hidden-tablet">Shop Name</span></a></li>
						<li><a href="gallery.html"><i class="icon-picture"></i><span class="hidden-tablet">Dalevery Man</span></a></li>
